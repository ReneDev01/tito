...
import 'package:tito/views/courses/course_end_adress.dart';
...
class EndAdress extends StatefulWidget {
  const EndAdress({super.key});

  @override
  State<EndAdress> createState() => _EndAdressState();
}

class _EndAdressState extends State<EndAdress> {
  List<Adress>? adress = [];
  final nameText = TextEditingController();

  final LocalStorage storageAdress = LocalStorage('localstorage_app');

  Future<void> _getArvAdress() async {
                        ...
                        GestureDetector(
                            onTap: () async {
                              ...
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => const CourseEndAdress()));
                            },
                            child: Container(
